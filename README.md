# nvim-treesitter-queries-groovy

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-groovy/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-groovy/actions/workflows/validate.yml)

Neovim tree-sitter queries for **groovy**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-groovy",
...
- [ ] Changes are scoped to `groovy` — do not include files for other languages
